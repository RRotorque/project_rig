...
label = tk.Label(content_frame, text="MQTT Connection")
label.pack(pady=5)
...
# subMain content area (scrolled text)
# Report preview label in the report preview frame
label2 = tk.Label(content_frame, text="COM connection")
label2.pack(pady=(5, 0), anchor='n')  # Adjust the pady values as needed

label2_scrolledtext = scrolledtext.ScrolledText(content_frame, state=tk.DISABLED)
label2_scrolledtext.pack(side=tk.LEFT, expand=True, fill='both')
